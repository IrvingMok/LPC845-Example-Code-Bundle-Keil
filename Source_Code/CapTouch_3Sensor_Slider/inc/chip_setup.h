...
#define USE_AVERAGED  1        // '1' to use averages for baseline band, '0' to use absolute high and low
#define NM_MULTIPLIER 1
#define NM_FRACTION 1          // Noise margin = (notouch_high-notouch_low)*(NM_MULTIPLIER/NM_FRACTION), or '0'
#define NUM_SENSORS 3          // How many sensors / X pins are being used
#define LOW_SENSOR 6
#define CHAIN_LENGTH 8         // Number of taps for the DC search filter
#define TOUCH_TRIGGERS_LOWER 1 // '1' if touch triggers lower, '0' if touch triggers higher than no-touch

#define DB_VAL 225             // If using debounce, count up to this number
#define DEBOUNCE 0             // '1' to introduce a debounce delay on the first touch after all sensors are above touch_threshold
#define FIR 1                  // '1' to use FIR averaging filter
...
#define FILTER_GAIN 3          // Must be Log2 of NUM_SAMPLES
...
#define FILTER_GAIN 3          // Log2 of NUM_SAMPLES
#define GET_SENSOR 0           // '1' to output the touched sensor number, '0' to output raw count data for all sensors

#define PWM_FREQ 100      // in cycles/second
#define PWM_RES  100      // in counts/cycle
#define LED_GF     2      // LED gain factor (increases brightness)
