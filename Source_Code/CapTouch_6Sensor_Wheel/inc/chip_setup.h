...
#define NUM_SENSORS 6          // How many sensors or X pins are being used
#define LOW_SENSOR 0           // The index of the lowest X pin used by this software
#define CHAIN_LENGTH 16        // Number of taps for the DC search filter
...
#define NUM_SAMPLES 8          // Memory of the FIR-average filter (a.k.a. 'L')
