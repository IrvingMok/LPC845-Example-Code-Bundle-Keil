...
#else
  #define DBGTXPIN P1_17           // Use with USB-to-RS232 break-out cable (choose your own favorite TxD pin)
  #define DBGRXPIN P1_16           // Use with USB-to-RS232 break-out cable (choose your own favorite RxD pin)
#endif
