...
* main() routine
  ...
  2. Examine the WDTOF flag. If set, this current reset is due to a watchdog event. Illuminate red LED and stop here.
...
* It is recommended that the code is compiled (built), then loaded to flash.
  Once loaded, reset the target on the board.
