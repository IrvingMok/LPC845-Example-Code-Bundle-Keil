...
// 
#define FRO_FREQ_VAL 0             // 0 = 18 MHz
...
#define FRO_DIRECT_VAL 0           // 0 = fro_dividers_out (reset value)
                                   // 1 = fro_oscout
...
#define WDTOSCCTRL_VAL 0x0A0       // bits 4:0 = DIVSEL (reset value = 00000)
...
#define SYSPLLCTRL_VAL 0x42        // bits 4:0 = MSEL: Feedback Divider Selection (reset value = 00000)
                                   ...
                                   //            PSEL = 10 ... P = 4
                                   //            PSEL = 11 ... P = 8
                                   // Example: How to get the PLL to generate 27 MHz given a 9 MHz input
                                   // 27 = 3*9 = 216/2*4 ... M=3, P=4 ... MSEL=2=00010b, PSEL=10b ... SYSPLLCTRL_VAL = 1000010b = 0x42
...
#define EXT_CLOCK_FORCE_ENABLE 1   // Force config. and enable of external_clk for use by other than main_clk or sys_pll0_clk
